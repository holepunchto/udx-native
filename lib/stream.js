...
const RECV_SOURCE_CURRENT = 0
const RECV_SOURCE_OTHER = 1

module.exports = class UDXStream extends streamx.Duplex {
  static get RECV_SOURCE_CURRENT() {
    return RECV_SOURCE_CURRENT
  }

  static get RECV_SOURCE_OTHER() {
    return RECV_SOURCE_OTHER
  }
  ...
  _onmessage(len, source) {
    this.emit('message', this.udx._consumeMessage(len), source)
