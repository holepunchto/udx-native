...
module.exports = class UDXStream extends streamx.Duplex {
  ...
  changeRemote (remoteId, port, host) {
    if (this._remoteChanginge) throw new Error('Remote already changing')
    ...
    this._remoteChanging = once(this, 'remote-changed')

    binding.udx_napi_stream_change_remote(this._handle, remoteId, port, host, family)
