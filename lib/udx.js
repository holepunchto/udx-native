...
module.exports = class UDX {
  ...
  get bytesTransmitted () {
    return Number(this._view64[binding.offsetof_udx_t_bytes_out >> 3])
  }

  get packetsTransmitted () {
    return Number(this._view64[binding.offsetof_udx_t_packets_out >> 3])
  }

  get bytesReceived () {
    return Number(this._view64[binding.offsetof_udx_t_bytes_in >> 3])
  }

  get packetsReceived () {
    return Number(this._view64[binding.offsetof_udx_t_packets_in >> 3])
  }
